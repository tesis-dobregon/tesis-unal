...
import { TableComponentProps } from "../../types/sensors/table/table";
                    ...
                    <TableHead >
                        <TableRow>
                           {header.map((headerProperty) => {
                             return  <StyledTableCell align="left">{headerProperty.showName && (headerProperty.name)}</StyledTableCell>
                           })} 
                        </TableRow>
                    </TableHead>
                    <TableBody>

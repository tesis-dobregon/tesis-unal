...
import { SensorContext, SensorActions, SensorPage } from "../../types/sensors/providers";
...
export const useSensors = () => {
  ...
  const handleOpenModal = useCallback((action?: SensorActions) => {
    sensorContext?.setSensor({
  ...
  const getDrawerComponent = useCallback((action?: SensorActions) => {
    switch (action) {
  ...
  return { handleCloseDrawer, handleOpenAddSensorDrawer, handleOpenModal, getDrawerComponent,sensorContext  };
};